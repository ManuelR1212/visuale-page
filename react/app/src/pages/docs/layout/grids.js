    ...
    return (
        <>
            ...
            <div class="container-3 smt-container-1 tab-container-3">
                ...
                <p class="container-3 smt-container-1 top-margin-0 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">El Grid es un etiqueta sencilla, que se encargar de ordenar todos los elementos de un contenedor, de manera que, si el mismo contiene varios elementos por separado, sean ordenados con una separación coherente entre ellos,
                ...
                <p class="container-3 smt-container-1 top-margin-0 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">Los Grid reciben un <b>display='grid'</b> el cual se encarga de ordenar los elementos,
