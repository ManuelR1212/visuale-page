    ...
    return (
        <>
            ...
            <div class="container-3 smt-container-1 tab-container-3">
                ...
                <p class="container-3 smt-container-1 top-margin-0 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">El Height es un parámetro que puede ser asignado a casi cualquier elemento dentro del código HTML, siempre y cuando de modificar su altura se trate. El mismo, está dividido en distintos tamaños,
                ...
                <div class="card-1">
                    <p class="container-3 smt-container-1 top-margin-0 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">Los números de los Height van de forma ascendente, mientras mayor sea el número de la etiqueta, mayor será el tamaño de la propiedad Height,
            ...
            <div class="card-1 container-3">
                ...
                <p class="container-3 smt-container-1 smt-txt-size-2sm top-margin-0 bottom-padding-5 tab-txt-size-5sm">Los height pueden ser utilizadas por distintos tamaños de pantalla,
