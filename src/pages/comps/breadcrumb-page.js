    ...
    return (
        <>
            ...
            <div class="container-3 smt-container-1 tab-container-3">
                ...
                <p class="container-3 smt-container-1 top-margin-0 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">El Breadcrumb de Visual E es un tipo de esquema de navegación
            ...
            <section class="container-3 smt-container-1 tab-container-2">
                ...
                <div class="container-2 smt-container-1 card-1 b-white50 tab-container-1">
                    ...
                    <p class="container-1 smt-container-1 top-margin-9 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">La estructura de los Breadcrumb de Visual E, es bastante sencilla y llamativa, la misma retorna un prop,
            ...
            <section class="container-3 smt-container-1 tab-container-2">
                ...
                <div class="container-2 smt-container-1 card-1 b-white50 tab-container-1">
                    ...
                    <p class="container-1 smt-container-1 top-margin-0 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">El Breadcrumb de Visual E, necesita que definas las variables correspondientes a los items e index para
                    ...
                    <p class="container-1 smt-container-1 top-margin-0 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">Luego de esto, utiliza la etiqueta Breadcrumbs para llamar al componente dentro de tu página web. A su
