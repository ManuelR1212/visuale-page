    ...
    return (
        <>
            ...
            <div class="container-3 smt-container-1 tab-container-3">
                ...
                <p class="container-3 smt-container-1 top-margin-0 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">Visual E proporciona  los button (botón), los cuales son elementos utilizados para crear botones clicables en la página web. 
            ...
            <section class="container-3 smt-container-1 tab-container-2">
                ...
                <div class="container-2 smt-container-1 card-1 b-white50 tab-container-1">
                    ...
                    <p class="container-1 smt-container-1 top-margin-9 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">Nuestros Botones cuentan con una estructura simple, haciendo uso de las props para poder usar de forma libre el componente dentro de tu archivo principal de forma individual, es decir, 
            ...
            <section class="container-3 smt-container-1 tab-container-2">
                ...
                <div class="container-2 smt-container-1 card-1 b-white50 tab-container-1">
                    ...
                    <p class="container-1 smt-container-1 top-margin-0 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">Por otro lado, de una forma similar que el resto 
                    ...
                    <div className="grid-u col-3  sh-col-4 tab-col-5 smt-col-4 container-4 tab-container-1 smt-container-1">
