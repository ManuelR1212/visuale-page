    ...
    return (
        <>
            ...
            <div class="container-3 smt-container-1 tab-container-3">
                ...
                <p class="container-3 smt-container-1 top-margin-0 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">En Visual E, el Searchbar o barra de navegación, 
            ...
            <section class="container-3 smt-container-1 tab-container-2">
                ...
                <div class="container-2 smt-container-1 card-1 b-white50 tab-container-1">
                    ...
                    <p class="container-1 smt-container-1 top-margin-9 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">Nuestro Searchbar, cuenta con diseño simple, completamente modificable y adaptable a cualquier tipo de estilos. 
                    ...
                    <p class="container-1 smt-container-1 top-margin-8 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">Es importante resaltar que el Searchbar cuenta con una función vacía, que debería ser la encargada de filtrar los elementos de búsqueda que desees. Sin embargo, eso lo dejamos completamente en tus manos, 
            ...
            <section class="container-3 smt-container-1 tab-container-2">
                ...
                <div class="container-2 smt-container-1 card-1 b-white50 tab-container-1">
                    ...
                    <p class="container-1 smt-container-1 top-margin-0 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">Al momento de utilizar el componente en tu página web, simplemente haz una importación sencilla del mismo. 
                    ...
                    <p class="container-1 smt-container-1 top-margin-8 bottom-padding-5 smt-txt-size-2sm tab-txt-size-5sm tab-container-1">Realiza todas tus búsquedas de una manera original y estilizada. Recuerda, puedes modificar los estilos en el archivo searchbar.js a tus necesidades. Juega con las props
